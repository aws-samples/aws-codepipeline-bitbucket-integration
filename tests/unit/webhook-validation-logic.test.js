...
describe('Webhook Validation Logic', () => {
  ...
  describe('API Gateway Response Logic', () => {
    const responseToApiGw = (statusCode, message, headers = {}) => {
      return {
    ...
    it('should create success response', () => {
      const response = responseToApiGw(200, 'Success');
    ...
    it('should create error response', () => {
      const response = responseToApiGw(400, 'Bad Request');
    ...
    it('should include custom headers', () => {
      const response = responseToApiGw(200, 'Success', { 'X-Custom': 'value' });
